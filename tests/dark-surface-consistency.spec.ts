...
async function boot(page:any){
 await page.addInitScript((s:any)=>{localStorage.setItem('fenix-preprod-auth',JSON.stringify(s));localStorage.setItem('fenix-remember-device','true');sessionStorage.setItem('fenix-theme','dark')},fakeSession);
...
test('modo oscuro no deja tarjetas blancas en Inmobiliarias ni Informes',async({page},testInfo)=>{
