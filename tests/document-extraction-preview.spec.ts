...
const families=fs.readFileSync(path.join(process.cwd(),'src/documentFamilySchemas.ts'),'utf8');
test('PDF extraction opens family-specific financial preview and keeps automatic apply visible',()=>{
 ...
 expect(preview).toContain('VISTA PREVIA FINANCIERA');
 ...
 expect(preview).toContain('No consta en este documento');
