...
const items=[
 {id:'aaaaaaaa-1111-4111-8111-bbbbbbbbbbbb',version:1,tarea:'Llamar a cliente',estado:'Pendiente',fecha_limite:'2026-08-24',prioridad:'Alta',responsable:'FIN-A',completada:false},
 {id:'bbbbbbbb-1111-4111-8111-cccccccccccc',version:2,tarea:'Revisar documentación',estado:'Completada',fecha_limite:'2026-08-20',prioridad:'Media',responsable:'FIN-A',completada:true},
 {id:'cccccccc-1111-4111-8111-dddddddddddd',version:3,tarea:'Seguimiento inmobiliaria',estado:'Pendiente',fecha_limite:'2026-08-23',prioridad:'Alta',responsable:'VIS-A',completada:false}
];
...
test.describe('Fénix PRE-PROD · contrato visual Agenda',()=>{
 test('muestra tareas canónicas, selección y patrón sticky/sort sin escribir datos',async({page},testInfo)=>{
  ...
  await expect(root.getByText('ACTIVAS EN FUENTE',{exact:true})).toBeVisible();
