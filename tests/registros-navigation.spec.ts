...
const registros=[{id:'3c681b1a-756d-8140-a690-f422a9251c37',registro:'Registro de la Propiedad de Cabra',activo:true,numero:'1',direccion:'Av. de ejemplo, 1',cp:'14940',municipio_sede:'Cabra',provincia:'Córdoba',municipios_cubiertos:'Cabra · Doña Mencía',registrador:'Profesional de prueba',telefono:'957 000 000',email:'registro@example.test',horario:'09:00–14:00'}];
...
async function boot(page:any){
 ...
 await page.route('**/functions/v1/fenix-registros-runtime-test/**',r=>r.fulfill({status:200,contentType:'application/json',body:JSON.stringify({source:'notion',items:registros})}));
}
