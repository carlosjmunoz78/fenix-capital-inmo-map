...
test('stack flotante único: micrófono, calculadora y chat',()=>{
  ...
  expect(css).toContain('.fenix-voice-hub{right:18px!important;bottom:130px!important}');
  ...
  expect(css).toContain('.fenix-voice-main{width:46px!important;height:46px!important;border-radius:14px!important');
