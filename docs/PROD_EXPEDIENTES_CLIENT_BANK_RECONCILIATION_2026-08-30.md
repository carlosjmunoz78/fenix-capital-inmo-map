...
2. Resolver las 7 relaciones de cliente reales con identidad canónica existente o mediante alta canónica si no existe, sin fusionar por simple parecido de nombre.
