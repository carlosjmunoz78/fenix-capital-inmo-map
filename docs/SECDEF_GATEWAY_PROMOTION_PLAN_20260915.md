...
- Repository main: `b966b8d83168503192faca43d252bcf263c36222`.
...
- Runtime Smoke security/availability checks remain active while exact live frontend SHA verification is only required on explicit manual PROD deployment.
...
- RUNTIME_SMOKE_FREEZE_AWARE: **HECHO**
