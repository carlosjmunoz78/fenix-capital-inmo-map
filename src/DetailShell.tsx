...
async function detailApi(code:string){return fetchNotionRuntime<any>(`/expedientes/${encodeURIComponent(code)}`);}
...
export default function DetailShell(){
 ...
 return <div className="ops-root detail-exp-root" style={{zIndex:5200}} data-theme={(sessionStorage.getItem('fenix-theme')||'light')}>
  ...
  <section className="ops-content detail-exp-content">
   ...
   <div className="detail-master-title"><span>FICHA MAESTRA</span><h1>{displayName}</h1><p>{canonical?'Fuente canónica Notion · acceso filtrado por tu rol.':'Ficha operativa autorizada por tu rol.'}</p></div>
