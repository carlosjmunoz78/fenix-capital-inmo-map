...
import {fetchReportsRuntime} from './reportsRuntime';
...
export default function InformesShell(){
 ...
 const body=<>
  ...
  {!loading&&status===200&&visible.length===0&&<div className="ops-empty" data-testid="informes-empty"><strong>Sin informes visibles</strong><span>No hay informes reales materializados en PROD dentro de tu ámbito. La pantalla permanece vacía en lugar de mostrar registros TEST.</span></div>}
