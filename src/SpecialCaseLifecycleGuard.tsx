...
export default function SpecialCaseLifecycleGuard(){
  ...
  useEffect(()=>{if(!active)return;const find=()=>setTarget(document.querySelector('.special-detail-experience-host'));find();const obs=new MutationObserver(find);obs.observe(document.body,{childList:true,subtree:true});return()=>{obs.disconnect();setTarget(null)}},[active,pathname]);
