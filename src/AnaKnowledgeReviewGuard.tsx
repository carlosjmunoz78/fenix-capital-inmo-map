...
const sourceForDisplay=(source?:string)=>{const clean=(source||'').replace(/\bPRE-PROD\b/gi,'').replace(/\bAPP\b/g,'Aplicación').replace(/\s*·\s*$/,'').replace(/\s{2,}/g,' ').trim();return clean||'—';};
