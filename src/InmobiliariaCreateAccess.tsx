...
export default function InmobiliariaCreateAccess(){
 ...
 useEffect(()=>{if(!active)return;const resolve=()=>setTarget(document.querySelector('.inmo-title'));resolve();const observer=new MutationObserver(resolve);observer.observe(document.body,{childList:true,subtree:true});return()=>observer.disconnect();},[active]);
