...
export default function OperationalTopbar({theme,onToggleTheme,query,onQueryChange,placeholder,name,role,avatarUrl='',initials,onLogout}:Props){
 return <header className="ops-top">
  <div className="ops-search"><Search size={17}/><input value={query} onChange={e=>onQueryChange(e.target.value)} placeholder={placeholder}/></div>
