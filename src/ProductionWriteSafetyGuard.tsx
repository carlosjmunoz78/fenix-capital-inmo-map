...
export default function ProductionWriteSafetyGuard(){
 ...
 if(!hit)return null;
 return <div data-testid="prod-write-safety" style={{position:'fixed',inset:0,zIndex:100000,display:'grid',placeItems:'center',padding:24,background:'rgba(10,18,28,.72)',backdropFilter:'blur(6px)'}}>
