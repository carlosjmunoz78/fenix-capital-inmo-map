...
export default function OperationalShellFrame({className='',theme,navigation,activeRoute,anaSubtitle,anaRoute,sidebarVariant='default',query,onQueryChange,searchPlaceholder,searchActionLabel,onSearchAction,name,role,avatarUrl='',initials,onToggleTheme,onLogout,topbar,mainClassName='',contentClassName='',legacyDirectionTheme=false,children}:Props){
 ...
 return <div className={rootClass} data-theme={effectiveTheme} data-dir-theme={legacyDirectionTheme?effectiveTheme:undefined}>
  <style>{`.ops-root>.ops-side{grid-column:1!important;visibility:visible!important;opacity:1!important;z-index:7800!important}.ops-root>.ops-main{grid-column:2!important}.ops-root>.ops-shared-footer{position:fixed!important;left:238px;right:0;bottom:0!important;z-index:2147483000!important;height:34px;display:flex!important;align-items:center!important;justify-content:center!important;border-top:1px solid var(--border,#e5e7eb)!important;background:var(--panel,#fff)!important;color:var(--muted,#667085)!important;font-size:11px!important;letter-spacing:.08em!important;text-align:center!important;visibility:visible!important;opacity:1!important;pointer-events:none}.ops-root.ops-direction-frame{grid-template-columns:238px minmax(0,1fr)!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:238px}.ops-root[data-theme='dark']>.ops-shared-footer{background:#202023!important;border-color:#343438!important;color:#aaaab2!important}@media(max-width:1000px) and (min-width:901px){.ops-root.ops-direction-frame{grid-template-columns:96px minmax(0,1fr)!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:96px}}@media(max-width:900px){.ops-root>.ops-shared-footer{left:96px}.ops-root.ops-direction-frame{grid-template-columns:96px minmax(0,1fr)!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:96px}}@media(max-width:760px){.ops-root.ops-direction-frame{display:block!important}.ops-root.ops-direction-frame>.ops-side{display:none!important}.ops-root.ops-direction-frame>.ops-main{grid-column:auto!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:0;bottom:0!important}}@media(max-width:650px){.ops-root>.ops-side{grid-column:auto!important}.ops-root>.ops-main{grid-column:auto!important}.ops-root>.ops-shared-footer{left:0;bottom:58px!important;height:30px;font-size:10px!important}}`}</style>
