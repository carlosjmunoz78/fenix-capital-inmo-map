...
export default function OperationalShellFrame({className='',theme,navigation,activeRoute,anaSubtitle,anaRoute,sidebarVariant='default',query,onQueryChange,searchPlaceholder,searchActionLabel,onSearchAction,name,role,avatarUrl='',initials,onToggleTheme,onLogout,topbar,mainClassName='',contentClassName='',legacyDirectionTheme=false,children}:Props){
 ...
 return <div className={rootClass} data-theme={effectiveTheme} data-dir-theme={legacyDirectionTheme?effectiveTheme:undefined}>
  <style>{`.ops-root>.ops-side{grid-column:1!important;visibility:visible!important;opacity:1!important;z-index:7800!important}.ops-root>.ops-main{grid-column:2!important}.ops-root>.ops-shared-footer{position:fixed;left:238px;right:0;bottom:0;z-index:7900;height:34px;display:flex;align-items:center;justify-content:center;border-top:1px solid var(--border,#e5e7eb);background:var(--panel,#fff);color:var(--muted,#667085);font-size:11px;letter-spacing:.08em;text-align:center;visibility:visible;opacity:1}.ops-root.ops-direction-frame{grid-template-columns:168px minmax(0,1fr)!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:168px}.ops-root[data-theme='dark']>.ops-shared-footer{background:#202023;border-color:#343438;color:#aaaab2}@media(max-width:1000px) and (min-width:901px){.ops-root.ops-direction-frame{grid-template-columns:72px minmax(0,1fr)!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:72px}}@media(max-width:900px){.ops-root>.ops-shared-footer{left:96px}.ops-root.ops-direction-frame{grid-template-columns:72px minmax(0,1fr)!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:72px}}@media(max-width:760px){.ops-root.ops-direction-frame{display:block!important}.ops-root.ops-direction-frame>.ops-side{display:none!important}.ops-root.ops-direction-frame>.ops-main{grid-column:auto!important}.ops-root.ops-direction-frame>.ops-shared-footer{left:0;bottom:0}}@media(max-width:650px){.ops-root>.ops-side{grid-column:auto!important}.ops-root>.ops-main{grid-column:auto!important}.ops-root>.ops-shared-footer{left:0;bottom:58px;height:30px;font-size:10px}}`}</style>
