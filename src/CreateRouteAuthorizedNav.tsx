...
function routeGroup(path:string){if(path==='/expedientes/nuevo')return'/expedientes';if(path==='/contactos/nuevo')return'/contactos';if(path==='/inmobiliarias/nueva')return'/inmobiliarias';if(path==='/tareas/nueva')return'/agenda';if(/^\/inmobiliarias\/[^/]+\/contactos\/nuevo$/.test(path))return'/inmobiliarias';return'';}
