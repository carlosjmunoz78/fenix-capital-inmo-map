...
returns jsonb language plpgsql security definer set search_path to 'fenix_prod','public','pg_temp' as $$
declare r text; items jsonb; active_count int; g jsonb; begin
