...
const base={context,authorized:true,requires_prod_write:false,confidence:0.9,source_refs:['c360:client-1'],touchpoints:[{channel:'email',stage:'lead',sentiment:0.5,response_minutes:30,issue_open:false},{channel:'phone',stage:'proposal',sentiment:-0.4,response_minutes:180,issue_open:true}]};
