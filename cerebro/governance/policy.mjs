...
function exceptionKey(ctx,eventId){return createHash('sha256').update(JSON.stringify([ctx.company_id,ctx.engine_id,ctx.environment,eventId])).digest('hex');}
